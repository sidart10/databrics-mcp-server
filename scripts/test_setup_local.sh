...
echo "🚀 Testing Databricks MCP Server setup locally..."

# Skip system package updates on macOS (they're for Codespaces/Linux)
echo "📦 Skipping system package updates (running on macOS)"
...
echo ""
echo "🎉 Local setup test complete!"
echo ""
...
echo "  DATABRICKS_WAREHOUSE_TOKEN: ${DATABRICKS_WAREHOUSE_TOKEN:-'Not set'}"
